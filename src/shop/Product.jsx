...
export default function Product({price, description}) {
  const [selectedColor, setSelectedColor] = useState(product.colors[0])
  const [selectedSize, setSelectedSize] = useState(product.sizes[2])


  // Realizar un POST para crear la sesión del carrito
  const handlePost = () => {
          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            ...
            <div className="mt-8 lg:col-span-5">
              <form>
                ...
                <Link
                  to="/cart"
                  className="mt-8 flex w-full items-center justify-center rounded-md border hover:border-transparent bg-indigo-600 px-8 py-3 text-base font-medium hover:text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Add to cart
                </Link>
              </form>
